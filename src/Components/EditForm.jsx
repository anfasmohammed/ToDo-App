...
const EditForm = ({editTask,id,taskName}) => {
  ...
  return (
    <form >
           ...
           <button onClick={update} className="font-semibold bg-gray-100 text-slate-600 px-2 text-2xl rounded border-2 border-gray-400 hover:bg-gray-400">Update</button>
